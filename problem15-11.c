/*
Ejercicio 15: Hacer un programa en C. Para guardar direcciones de correo que muestre un menú con las siguientes opciones: 
...
void crear(){
	...
	do{
		...
		printf("Digite su email: ");gets(datos.email);
